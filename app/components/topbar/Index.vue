<template>
  <div class="fixed top-0 left-0 right-0 z-50">
    ...
    <div
      class="absolute inset-0 backdrop-blur-2xl bg-white/70 dark:bg-gray-900/70 border-b border-white/20 dark:border-gray-700/30"
    ></div>
      ...
      <div class="flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div class="relative">
          ...
          >
            <div
              v-show="isMenuOpen"
              class="absolute right-0 top-full mt-3 w-72 backdrop-blur-2xl bg-white/80 dark:bg-gray-900/80 rounded-3xl shadow-2xl border border-white/30 dark:border-gray-700/30 overflow-hidden"
            >
