...
<template>
  ...
  >
    ...
    <div class="mb-10">
      ...
      <div
        v-if="selectedTheme"
        class="bg-white dark:bg-dark rounded-3xl p-5 shadow-xl border border-gray-200/50 dark:border-gray-700/50"
      >
        <div class="flex items-center gap-3 mb-4">
          <div
            class="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl shadow-md"
          >
    ...
    <button
      ...
      :class="[
        'py-4 px-8 mb-10 mx-auto rounded-2xl bg-linear-to-r text-white text-lg font-semibold transition-all duration-300 flex items-center gap-2',
        isLoading || currentTheme.id == selectedTheme.id
          ? 'cursor-not-allowed from-green-500 to-teal-500 opacity-70'
          : 'cursor-pointer from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 hover:scale-105 active:scale-95',
      ]"
    >
