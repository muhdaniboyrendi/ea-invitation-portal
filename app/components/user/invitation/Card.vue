<template>
  <div
    class="relative bg-off-white dark:bg-dark rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden"
  >
    <!-- Card Content -->
    <div class="relative p-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div
          class="text-center p-4 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700"
        >
          <div
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div
          class="p-3 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700"
        >
          <div class="flex items-center space-x-3">
            <div
        ...
        <div
          class="py-3 px-4 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700"
        >
          <div class="flex items-center space-x-3">
            <div
